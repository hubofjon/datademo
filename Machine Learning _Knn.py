...
# dave the model
    pickle.dump(clf, open(r'G:\\py_models\ml_knn_model.dat',"wb"))
    #clf_1=pickle.load(open(r'G:\\py_models\ml_knn_model.dat',"r") )
...
def ml_knn_apply(df):
    ...
    x=x.values 
    y=y.values
    clf=pickle.load(open(r'G:\\py_models\ml_knn_model.dat',"rb"))
